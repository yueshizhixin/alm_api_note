...
public class NoteController {
    ...
    public String addTag(@ApiParam(value = "标签层级")@RequestParam int layer, @RequestParam int tagId1, @RequestParam String tagName, HttpServletRequest req) {
    ...
    public String getNoteById(@ModelAttribute Note note) {
        ...
        noteService.updateGetNoteByIdCallback(n);
